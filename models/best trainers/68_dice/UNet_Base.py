...
class UNet(nn.Module):
    def __init__(self, num_classes, activation=nn.PReLU):
        ...
        self.enc1 = _EncoderBlock(1, 16, activation=activation)
        self.enc2 = _EncoderBlock(16, 32, activation=activation)
        self.enc3 = _EncoderBlock(32, 64, activation=activation)
        self.enc4 = _EncoderBlock(64, 128, activation=activation)
        self.enc5 = _EncoderBlock(128, 256, activation=activation)


        self.center = _DecoderBlock(256, 512, 256, activation=activation)

        self.dec5 = _DecoderBlock(512, 256, 128, activation=activation)
        self.dec4 = _DecoderBlock(256, 128, 64, activation=activation)
        self.dec3 = _DecoderBlock(128, 64, 32, activation=activation)
        self.dec2 = _DecoderBlock(64, 32, 16, activation=activation)
...
class SegNet(nn.Module):
    def __init__(self):
        ...
        self.enc5 = _EncoderBlock(128, 256, dropout=True)
        self.enc6 = _EncoderBlock(256, 512, dropout=True)

        self.fc = nn.Conv2d(512,1,(2,2))
