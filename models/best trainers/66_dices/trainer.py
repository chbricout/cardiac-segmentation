...
def runTraining():
    ...
    CE_loss = torch.nn.CrossEntropyLoss(weight=torch.FloatTensor([ 0.03, 0.5, 0.27, 0.2]))
    ...
    for i in range(epoch):
        ...
        for j, data in enumerate(train_loader_full):
            ...
            lossTotal = CE_loss_value  + 5 * prop_diff_value
            ...
            printProgressBar(
                ...
                length=15,
                suffix=" Loss: {:.4f}, prop diff : {:.4f}, gan : {:.4f}".format(
                    lossTotal, prop_diff_value, loss_bce_fake + loss_bce_real
                ),
            )
        ...
        if i >= 0:
            ...
            for j, data in enumerate(train_loader_unlabeled):
                ...
                if i > 80 :
                    ...
                    likely_loss = discNet(sum_pred)
                    lossTotal += 0.5* likely_loss.mean()
